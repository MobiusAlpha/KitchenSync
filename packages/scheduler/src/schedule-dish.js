 ...
 */
export function scheduleDish(dish, targetTime, now) {
    ...
    const earliestStartMinutes = events[0].startTime.hour * 60 + events[0].startTime.minute;
    const nowMinutes = now.hour * 60 + now.minute;
    const overrunMinutes = nowMinutes > earliestStartMinutes ? nowMinutes - earliestStartMinutes : null;
    return { targetTime, events, overrunMinutes };
}
//# sourceMappingURL=schedule-dish.js.map